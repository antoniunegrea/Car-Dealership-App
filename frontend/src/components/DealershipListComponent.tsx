...
import '../styles/dealershipList.css';
...
const DealershipListComponent: React.FC<DealershipListProps> = ({
    dealerships,
    onDelete,
            ...
            {displayedDealerships.map((dealership) => (
                <div key={dealership.id} className="dealership-item">
                    <div className="dealership-info">
                        <h3 onClick={() => handleDealershipClick(dealership.id)}>
                            {dealership.name}
                        </h3>
                    ...
                    <div className="car-actions">
                        <button 
                            onClick={() => navigate(`/dealerships/edit/${dealership.id}`)} 
                            className="edit-btn"
                        >
                            Edit
                        </button>
